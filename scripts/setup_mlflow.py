...
def setup_mlflow(backend_store_uri="sqlite:///mlflow.db", artifact_store="./mlruns"):
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Set up and start an MLflow tracking server")
    parser.add_argument(
        "--backend", 
