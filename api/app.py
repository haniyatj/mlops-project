...
MODEL_PATH = os.environ.get('MODEL_PATH', '../models/linear_regression_model.joblib')
...
def predict():
    ...
    try:
        ...
        features, actual = prepare_data_from_json(stock_data, target_col='close', lookback=5)
        ...
        # Format for response
        data = []
        for i, (idx, act, pred) in enumerate(zip(actual.index, actual, predictions)):
            data.append({
